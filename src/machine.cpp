...
// Compute path length to filter short trajectories
void Machine::compute_path_length(){
    Complex position = center;
    float t = 0;
    while(t < 2*pi){
        for(int i = 0; i < 2*N; i++)
